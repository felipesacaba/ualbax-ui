...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'financeiro/registrar-pedido',
        loadChildren: () => import('./financeiro/registrar-pedido/registrar.pedido.module').then(m => m.RegistrarPedidoModule)
      },
      {
        path: 'financeiro/consultar-pedido',
